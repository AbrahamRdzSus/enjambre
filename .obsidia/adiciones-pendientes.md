...
- pendiente | 2026-08-08 | Headroom (headroom-ai / chopratejas/headroom, Apache-2.0): capa de compresion de contexto (50-90% menos tokens) | -> usar/idea | seguridad: local-first declarado; confirmar no-telemetria clonando antes de adoptar (ve datos sensibles) | ref:REPO_EVAL_CATALOG
